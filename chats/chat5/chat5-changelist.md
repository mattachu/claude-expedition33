...
FILE: overview/claude-expedition33.md
SECTION: ## Section 5: Party > ### Maelle
CONTENT:
### Maelle
...
FILE: overview/claude-expedition33.md
SECTION: ## Section 5: Party > ### Monoco
CONTENT:
### Monoco
...
1. Output the in-game actions checklist from `actions` — **do this BEFORE step 2 so it appears verbatim in the transcript**
...
FILE: overview/maelle.md
SECTION: ## Pictos > ### Solo loadout (The Reacher)
CONTENT:
...
| Gommage         | 3             | ✅       | Unlocked at Relationship Level 7 (after The Reacher — chose "Truth"). Kills weak targets; otherwise extreme Void damage 1 hit, then changes to Virtuose Stance. Confirmed extremely powerful — 3.4M damage on Serpenphare. Required for Renoir fight. |

-----

FILE: overview/maelle.md
SECTION: ## Errors to Avoid
AFTER: **Melarum source:**
CONTENT:
...
NEW FILE: overview/pictos-lumina.json
CONTENT: See output file pictos-lumina.json — working data file for Pictos and Lumina reference. Definitive source; do not edit pictos-lumina.md directly.

NEW FILE: overview/pictos-lumina.md
CONTENT: See output file pictos-lumina.md — generated from pictos-lumina.json by generate_pictos_lumina.py. Re-generate after editing JSON.

NEW FILE: scripts/generate_pictos_lumina.py
CONTENT: See output file generate_pictos_lumina.py — reads overview/pictos-lumina.json and writes overview/pictos-lumina.md.
Usage: python3 scripts/generate_pictos_lumina.py [input.json] [output.md]

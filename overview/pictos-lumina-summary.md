...
| Exposing Break         | Added  | 5  | Personal addition. Apply Defenceless on Breaking a target - synergy with Energising Break and sets up End Bringer.                                                                                                       |
...
| Powerful On Shell | 10 | Apply Powerful on applying Shell.                                                           | Get all status effects for the price of one.                                                                                                       |
| Rush On Powerful  | 10 | Apply Rush on applying Powerful.                                                            | Get all status effects for the price of one.                                                                                                       |
| Shell On Rush     | 10 | Apply Shell on applying Rush.                                                               | Get all status effects for the price of one.                                                                                                       |
| Greater Powerful  | 10 | +15% to Powerful damage increase.                                                           | Make status effects better.                                                                                                                        |
| Greater Rush      | 10 | +25% to Rush Speed increase.                                                                | Make status effects better.                                                                                                                        |
| Greater Shell     | 10 | +10% to Shell damage reduction.                                                             | Make status effects better.                                                                                                                        |
| Longer Powerful   | 10 | On applying Powerful, its duration is increased by 2.                                       | Make status effects better.                                                                                                                        |
| Longer Rush       | 10 | On applying Rush, its duration is increased by 2.                                           | Make status effects better.                                                                                                                        |
| Longer Shell      | 10 | On applying Shell, its duration is increased by 2.                                          | Make status effects better.                                                                                                                        |
<!-- GENERATED:END -->

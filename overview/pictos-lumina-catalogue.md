...
| ✓ | Energising Burn | +1 AP on applying Burn. Once per turn. | 10 |  |  |
...
| ✓ | Energising Pain | No longer gain AP on Parry. +1 AP on getting hit. | 10 |  |  |
...
| ✓ | Breaking Death | Fully charge enemy break bar on death | 5 | Verso | death |
...
| ✓ | Augmented Counter I | 25% increased Counterattack damage. | 3 |  |  |
...
| ✓ | Base Shield | Grants 1 Shield HP buffer per turn | 20 |  |  |
| ✓ | Confident | Take 50% less damage, but can't be healed. | 20 |  |  |
...
| ✓ | Cleansing Tint | Healing Tints also remove all Status Effects from the target. | 5 |  |  |

...
- **Pictos optimisation (main team):** Deferred to Opus session. Key questions: who should hold EM Pictos long-term; Maelle slot 3 (Survivor vs Recovery vs other); Sciel slot 3 (Quick Break is pure stat stick — better options available); Verso (Confident as Pictos saves 20LP Lumina). See Chat 6 handoff block for full details.

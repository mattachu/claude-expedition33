...
**Joyaro starts in Almighty Mask** (Level 4 ability).
...
**Situational Pictos (swap in for specific bosses):**
...
- **Joyaro over Nusaro:** Respec complete. Agility 99 / Defence 99 confirmed optimal. Joyaro L4 (Almighty Mask start) and L20 (Break damage doubled in Almighty) are strong for break role.
...
- **Nusaro as endgame weapon:** Said Nusaro Level 20 is the endgame weapon. Correct: endgame weapon is Joyaro.
- **Abbest Wind removal:** Recommended removing it. Wrong: essential for wheel cycling and free second turn. Matt corrected this.
- **Auto Shell = Base Shield:** Distinct mechanics. Base Shield = 1 damage-absorbing shield buffer per turn; Shell = 20% damage reduction for 3 turns.
